...
export default function GoogleSignInButton({ onLogin }) {
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="mt-2 w-full flex items-center justify-center gap-3 px-6 py-3 bg-white border border-gray-300 rounded-2xl font-black text-xs uppercase tracking-widest active:scale-95 transition-all shadow-sm"
    >
